---
layout: default
title: Websphere - Jython - DeployApp 
parent:  Websphere - Jython
---


~~~py
# Complete Script to Deploy an App. 
# Usage:
#   /path/to/profile/wsadmin 
#              -f deployApp.py myapp path/to/myapp.ear localhostNode01 server1 server1_host
#
